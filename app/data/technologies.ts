...
export const technologies: Technology[] = [
  {
    ...
    tagline:
      "Automatic residual current protection that resets without manual intervention, minimizing charger downtime.",
    icon: ShieldCheck,
    ...
    sections: [
      {
        ...
        description:
          "Our self-resettable RCD technology detects residual current faults and automatically restores operation after the fault clears, eliminating the need for on-site technician visits.",
        points: [
          ...
          "Remote monitoring of fault events via OCPP",
        ],
      ...
      },
      {
        ...
        description:
          "Ideal for chargers deployed at highways, parking lots, and remote fleet depots where immediate manual intervention is not feasible.",
        points: [
  ...
  },
  {
    ...
    tagline:
      "Intelligent power distribution across multiple chargers without a central controller, optimizing site-level energy use.",
    icon: Network,
    ...
    sections: [
      {
        ...
        description:
          "Each charger communicates directly with its neighbors to dynamically allocate available power, ensuring optimal utilization of the site's electrical capacity.",
        points: [
      ...
      },
      {
        ...
        description:
          "The load balancer interfaces with building energy management systems and utility demand-response signals to keep site power within contracted limits.",
        points: [
          ...
          "Dashboard for site-level energy analytics",
        ],
  ...
  },
  {
    ...
    tagline:
      "End-to-end cloud platform for managing charger networks — from monitoring and billing to user management and analytics.",
    icon: Monitor,
    heroImage: "/technology/operations-suite.jpg",
    sections: [
      {
        heading: "Centralized Charger Management",
        description:
          "Monitor, control, and configure your entire charger fleet from a single dashboard. Full OCPP 1.6J and 2.0.1 support with real-time status visibility.",
        points: [
          "Live charger status, session tracking, and error diagnostics",
          "Remote start/stop, configuration, and firmware updates",
          "Multi-tenant architecture for CPOs and eMSPs",
          "Role-based access with granular permissions",
        ],
        image: "/technology/ops-dashboard.jpg",
      },
      {
        heading: "Billing & Revenue Management",
        description:
          "Flexible pricing engine supporting time-based, energy-based, and flat-rate tariffs with integrated payment processing.",
        points: [
          "Automated invoice generation and settlement",
          "Support for prepaid wallets, subscriptions, and roaming",
          "GST-compliant billing for Indian market",
          "Revenue analytics and financial reporting",
        ],
        image: "/technology/ops-billing.jpg",
      },
      {
        heading: "User & Driver Experience",
        description:
          "White-label mobile app and driver portal for charger discovery, session management, and payment.",
        points: [
          "Charger map with real-time availability",
          "QR code and RFID-based session initiation",
          "Push notifications for session events",
          "Driver ratings and support ticket management",
        ],
        image: "/technology/ops-user.jpg",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    tagline:
      "AI-powered predictive maintenance and analytics platform that anticipates failures before they cause downtime.",
    icon: Brain,
