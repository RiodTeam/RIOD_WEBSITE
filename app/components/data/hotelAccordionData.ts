// data/hotelAccordionData.ts

export const hotelAccordionData = [
  {
    title: "Turnkey Installation With Minimal Property Disruption",
    desc: `We handle the entire installation process from site assessment and hardware setup to network 
    integration ensuring the project is completed smoothly and efficiently. Our team works around your operational 
    hours to avoid guest inconvenience and preserve the hotel’s aesthetic and infrastructure. `,
    image: "/hotel/img1.webp",
  },
  {
    title: "Revenue-sharing or hotel-owned model",
    desc: `Choose the business model that works best for your property. Whether you prefer a zero-investment revenue-share
     approach or want complete ownership of the chargers, RIOD provides flexible options that optimize profitability and long-term value. `,
    image: "/hotel/img2.webp",
  },
  {
  ...
  },
  {
   ...
   app-based access, and automated reporting. This ensures easy management for staff and a frictionless experience for guests. .`,
    image: "/hotel/img5.webp",
  },
];

export const officeAccordionData = [
  {
    title: " Flexible Ownership & Commercial Models ",
    desc: `Choose the deployment strategy that best suits your business goals, whether through company-owned chargers, flexible leasing options, or revenue-sharing models. These approaches help minimize upfront costs while maximizing long-term value and scalability. `,
    image: "/office/img1.webp",
  },
  {
    title: "Intelligent Load Balancing for Office Power Systems ",
    desc: `RIOD chargers intelligently manage electrical load, allowing multiple EVs to charge simultaneously without overloading the system. This ensures stable performance while eliminating the need for costly electrical infrastructure upgrades. `,
    image: "/office/img2.webp",
  },
  {
  ...
  },
  {
    ...
    image: "/office/img5.webp",
  },
];

export const InstitutionAccordionData = [
  {
    title: "Seamless, Campus-Friendly Installation ",
    desc: `RIOD manages the entire installation process efficiently, ensuring minimal disruption to daily academic activities. Our approach allows institutions to deploy EV charging infrastructure smoothly while maintaining a safe and uninterrupted campus environment. `,
    image: "/institution/img1.webp",
  },
  {
    title: "Flexible Investment & Deployment Options ",
    desc: `Choose from institution-owned, leased, or revenue-sharing models based on your budget and long-term goals. Each option offers flexibility while helping institutions deploy EV charging infrastructure in a cost-effective and scalable way. `,
    image: "/institution/img2.webp",
  },
  {
...
export const homeAccordionData = [
  {
    ...
    desc: `Our team manages the entire process, from evaluating your existing electrical setup to installing and activating your charger. This ensures a smooth, hassle-free experience with minimal disruption to your home and daily routine. `,
    image: "/home2/img1.webp",
  },
  {
    title: "Safe & Efficient Power Management",
    desc: `RIOD chargers intelligently balance electrical load to protect your home’s electrical system and prevent overloads during charging. This ensures safe, reliable, and consistent performance every day while supporting the efficient use of available power. `,
    image: "/home2/img2.webp",
  },
  {
