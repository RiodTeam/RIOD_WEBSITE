...
export const insightsData: InsightType[] = [
 {
  ...
  sections: [
    ...
    {
      heading: "Freezer/Refrigeration failure is one of the major problems that can affect the quality of vaccines in particular.",
      paragraphs: [
    ...
    {
      heading: "How RIOD Sensei wireless micro-nodes help in the monitoring of entire supply chain.",
      paragraphs: [
...

 {
  ...
  sections: [
    ...
    {
      heading: "In a chicken hatchery, even small changes in temperature and humidity matter.",
      paragraphs: [
    ...
    {
      heading: "Tracking Temperature and Humidity Across Multiple Incubators to Increase Hatchery Efficiency",
      paragraphs: [
    ...
    {
      heading: "Accurate Humidity and Temperature Monitoring for Better Hatchery Control",
      paragraphs: [
